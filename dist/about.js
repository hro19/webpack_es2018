...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/polyfill */ \"./node_modules/@babel/polyfill/lib/index.js\");\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance\"); }\n\nfunction _iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\n\n\nvar sankaku = function sankaku(teihen, takasa) {\n  return teihen * takasa / 2;\n};\n\nconsole.log(sankaku(20, 4));\n\nvar en = function en(hankei) {\n  return hankei * hankei * 3.14;\n};\n\nconsole.log(en(10));\nvar hairetu = [2, 5, 7, 9, 14];\nvar includeskekka = hairetu.includes(14) ? '含まれています' : '含まれていない';\nvar includeskekka2 = hairetu.includes(8) ? '含まれています' : '含まれていない';\nconsole.log(includeskekka);\nconsole.log(includeskekka2);\nvar hiduke = '2019/2/19';\n\nvar _hiduke$split = hiduke.split('/'),\n    _hiduke$split2 = _slicedToArray(_hiduke$split, 3),\n    yy = _hiduke$split2[0],\n    mm = _hiduke$split2[1],\n    dd = _hiduke$split2[2];\n\nconsole.log(yy + '年' + mm + '月' + dd + '日');\nvar nimotu = [8, 9, 10, 11, 12, 14];\nvar souko = [2, 3, 4, 5];\nvar okiya = [3, 4, 5].concat(nimotu);\nconsole.log(nimotu);\nconsole.log(okiya);\n\n//# sourceURL=webpack:///./src/about.js?");
